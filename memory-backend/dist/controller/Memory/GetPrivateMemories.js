...
var getAllPrivateMemories = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorization, authToken, id, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                authorization = req.headers.authorization;
                authToken = (authorization === null || authorization === void 0 ? void 0 : authorization.split(' ')[1]) || '';
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                id = (0, tokenDecoder_1.tokenDecoder)(authToken).id;
                return [4 /*yield*/, memory_1.memories.find({
                        isPublic: { $eq: false },
                        userId: id,
                    })];
            case 2:
